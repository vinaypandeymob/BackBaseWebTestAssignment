...
function getReasonPhrase(statusCode) {
    var result = codes_1.statusCodeToReasonPhrase[statusCode.toString()];
    if (!result) {
...
function getStatusCode(reasonPhrase) {
    var result = codes_1.reasonPhraseToStatusCode[reasonPhrase];
    if (!result) {
